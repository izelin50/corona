    ...
    <center>
        <div id="content" style=" padding-top: 0; width: 50%; background-color: white; height: 100%;">
            ...
            <div id="hidden1" style="display: none; text-align: left;">
                ...
                смертность, концентрация вируса в популяции, рациональность расходованияя производимых клетками ресурсов.
                Средние за цикл данные по этим параметрам отображаются на графиках.<br>
            ...
            <div id="hidden2" style="display: none;">
                ...
                <form method="post" action="input">
                    ...
                    <input min="2" max="100" type="number" onkeyup="this.value = this.value.replace(/[^\d]/g,'');" name="members" required
